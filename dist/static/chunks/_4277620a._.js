...
"[project]/src/hooks/useParticles.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useParticles = function() {
    ...
    const createParticle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useParticles.useCallback[createParticle]": (width, height)=>{
    ...
    }["useParticles.useCallback[createParticle]"], [
        colors,
        speed,
        size,
        opacity
    ...
    const initializeParticles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useParticles.useCallback[initializeParticles]": (width, height, count)=>{
    ...
    }["useParticles.useCallback[initializeParticles]"], [
        createParticle
    ]);
    const drawConnections = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useParticles.useCallback[drawConnections]": (ctx)=>{
            particlesRef.current.forEach({
                "useParticles.useCallback[drawConnections]": (particle, i)=>{
                    particlesRef.current.slice(i + 1).forEach({
                        "useParticles.useCallback[drawConnections]": (otherParticle)=>{
                    ...
                    }["useParticles.useCallback[drawConnections]"]);
                }
            }["useParticles.useCallback[drawConnections]"]);
        }
    }["useParticles.useCallback[drawConnections]"], [
    ...
    const updateAndDrawParticles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useParticles.useCallback[updateAndDrawParticles]": (ctx, width, height)=>{
            particlesRef.current.forEach({
                "useParticles.useCallback[updateAndDrawParticles]": (particle, index)=>{
                    // Update position
            ...
            }["useParticles.useCallback[updateAndDrawParticles]"]);
        }
    }["useParticles.useCallback[updateAndDrawParticles]"], [
        createParticle
    ]);
    const animate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useParticles.useCallback[animate]": (ctx, width, height)=>{
            ctx.clearRect(0, 0, width, height);
            drawConnections(ctx);
            updateAndDrawParticles(ctx, width, height);
        }
    }["useParticles.useCallback[animate]"], [
        drawConnections,
    ...
    const startAnimation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useParticles.useCallback[startAnimation]": (ctx, width, height)=>{
            const animateFrame = {
                "useParticles.useCallback[startAnimation].animateFrame": ()=>{
    ...
    }["useParticles.useCallback[startAnimation]"], [
        animate
    ]);
    const stopAnimation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useParticles.useCallback[stopAnimation]": ()=>{
...
_s(useParticles, "jUHxz7P3kpwo+orYaLmT2Aa1ErQ=");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useParticles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useParticles.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
;
const ParticleBackground = (param)=>{
    let { intensity = 'medium', theme = 'red-white', customColors, showConnections = true, className = '' } = param;
    _s();
    ...
    const { initializeParticles, startAnimation, stopAnimation } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useParticles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParticles"])({
        colors,
...
_s(ParticleBackground, "o5zCGkftwdfyHZCYRTha3APFqNM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useParticles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParticles"]
    ];
});
...
//# sourceMappingURL=_4277620a._.js.map