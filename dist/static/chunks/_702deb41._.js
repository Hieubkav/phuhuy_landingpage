...
const FloatingParticles = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FloatingParticles.useEffect": ()=>{
            ...
            const resizeCanvas = {
                "FloatingParticles.useEffect.resizeCanvas": ()=>{
            ...
            // Particle colors (red and white variants)
            const colors = [
                '#ff4444',
                '#ff6666',
                '#ff8888',
                ...
                '#f0f0f0',
                '#e0e0e0',
                '#d0d0d0' // White variants
            ];
            // Create initial particles
            const createParticle = {
                "FloatingParticles.useEffect.createParticle": ()=>{
            ...
            // Animation loop
            const animate = {
                "FloatingParticles.useEffect.animate": ()=>{
                    ctx.clearRect(0, 0, canvas.width, canvas.height);
                    // Draw connections between nearby particles
                    particlesRef.current.forEach({
                        "FloatingParticles.useEffect.animate": (particle, i)=>{
                            particlesRef.current.slice(i + 1).forEach({
                                "FloatingParticles.useEffect.animate": (otherParticle)=>{
                    ...
                    particlesRef.current.forEach({
                        "FloatingParticles.useEffect.animate": (particle, index)=>{
                            ...
                            ctx.fill();
                            ctx.restore();
                            // Add subtle glow effect for red particles
...
_s(FloatingParticles, "in4Kgcnry5iKT75klnRmU24pzoE=");
...
//# sourceMappingURL=_702deb41._.js.map